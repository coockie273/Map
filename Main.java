...
//_____________________________________________________ TESTS ___________________________________________//
...
public class Main {
    public static void main(String[] args) {
        ...
        HashMap map = HashMap.linearBuilder().setStep(12).setCapacity(defaultCapacity).setLoadFactor(12).build();
